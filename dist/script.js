...
async function run(akoamLink) {
    const browser = await puppeteer_extra_1.default.use(puppeteer_extra_plugin_stealth_1.default()).launch({ headless: true, args: ['--no-sandbox', '--disable-setuid-sandbox', "--no-zygote"] });
